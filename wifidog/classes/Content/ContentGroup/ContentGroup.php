...
class ContentGroup extends Content {
	...
	private $CONTENT_ORDERING_MODES = array (
		...
		'PSEUDO_RANDOM' => "Pick content elements randomly, but do not display the same content twice untill all content has been seen",
	...
	* */
	...
	public function getAdminUI($subclass_admin_interface = null, $title = null) {
		...
		foreach ($this->getElements("AND (valid_until_timestamp IS NULL OR valid_until_timestamp >= CURRENT_TIMESTAMP) \n") as $element) {
			$html .= "<li class='admin_element_item_container'>\n";
