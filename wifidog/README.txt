...
js:		Javascripts
lib:		PHP includes and classes maintained outside wifidog.  Some are merely installed there, some are distributed with wifidog.
...
portal:		Portal page
templates:	Smarty templates (Note that those are meant to ease development, not for customization)
