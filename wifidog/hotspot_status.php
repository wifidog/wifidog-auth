...
if ($format == 'RSS') {
    ...
    $textnode = $xmldoc->createTextNode(utf8_encode(_("WiFiDog list of the most recent HotSpots opened by ").HOTSPOT_NETWORK_NAME));
...
$i=0;
    ...
    foreach($node_results as $node_row) {
      ...
      if($node_row['is_up']=='t')
      {
      $title_str .= " (Currently Up)";
      }
      else
      {
            $title_str .= " (Currently Down)";
      }
      ...
      /* description */
      /* lom_1_4_descriptions_has_langstrings */
      $description = $xmldoc->createElement("description");
      ...
      {
          $description_text.=" "._("Mass transit:")." ".$node_row['mass_transit_info'];
      }
